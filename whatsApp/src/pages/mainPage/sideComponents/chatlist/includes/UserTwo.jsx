...
import profile from "../images/user_two.jpg"
import { UserState } from '../../../../../context/StateContext';

const UserTwo = () => {
    const {handleShowSecondList} = UserState()

    return (
        <div>
            <div onClick={handleShowSecondList} className="w-full mx-auto mb-[5px] pl-3 pr-[7px]  flex justify-start items-center hover:bg-hoverClr hover:cursor-pointer">
            <div className="w-[60px] h-[50px] mr-[1rem]">
                ...
                <div className="w-[100%] flex items-center justify-between border-b border-gray-800">
                    <div className="flex flex-col justify-center items-start py-2 text-textWhite">
                        <span className="text-lg font-[300]">Mohammed Ali</span>
                        <span className="text-sm text-iconClr">U'r welcm.</span>
                    </div>
